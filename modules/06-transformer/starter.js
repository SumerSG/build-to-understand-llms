...
//
// You build it on lib/tensor.js (the autograd engine from the autograd module) with the multi-head attention from lib/attention.js
// (the attention module). Everything below the worked example is yours to implement.

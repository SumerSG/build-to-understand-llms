...
export default async function demo(m, lab) {
  ...
  lab.plot({ title: `Exact-match caption accuracy on ${heldOut.length} held-out images`, x: accSteps, series: [{ name: 'held-out accuracy', values: accs }], xlabel: 'step', ylabel: 'fraction correct' });
